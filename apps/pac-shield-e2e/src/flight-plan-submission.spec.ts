...
//   const addFlightPlanButton = page.locator('button', { hasText: 'ATO' });
...
//   await page.getByText('Kadena Air Base - Japan').click();

//   // Fill in final destination
//   await page.getByLabel('Final Destination').click();
//   await page.getByText('FOS 1 - Japan').click();

//   // Fill in alternate destination

//   await page.getByText('Alternate Destination').click();
//   await page.getByText('Andersen Air Base - Guam').click();
...
//   await page.getByRole('option', { name: 'Cargo Only' }).click();
