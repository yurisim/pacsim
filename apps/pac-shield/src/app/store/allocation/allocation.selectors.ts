...
export const selectAllNotifications = createSelector(
  selectAllocationState,
  (state: AllocationState) => state.notifications
);

export const selectUnreadNotificationCount = createSelector(
  selectAllocationState,
  (state: AllocationState) => state.unreadNotificationCount
);

export const selectLastNotificationTimestamp = createSelector(
  selectAllocationState,
  (state: AllocationState) => state.lastNotificationTimestamp
);

export const selectNotificationsPanelOpen = createSelector(
  selectAllocationState,
  (state: AllocationState) => state.ui.notificationsPanelOpen
);

export const selectNotificationError = createSelector(
  selectAllocationState,
  (state: AllocationState) => state.ui.notificationError
);

export const selectProcessingNotification = createSelector(
  selectAllocationState,
  (state: AllocationState) => state.ui.processingNotification
);
...
export const selectUnacknowledgedNotifications = createSelector(
  selectAllNotifications,
  (notifications) => notifications.filter(n => n.requiresAcknowledgment && !n.acknowledged)
);
...
export const selectHasUnreadUrgentNotifications = createSelector(
  selectUnreadNotifications,
  (unreadNotifications) => unreadNotifications.some(n => n.priority === 'URGENT')
);

export const selectNotificationStats = createSelector(
  selectAllNotifications,
  selectUnreadNotificationCount,
  selectUnacknowledgedNotifications,
  (allNotifications, unreadCount, unacknowledged) => ({
