...
export const allocationNotificationReceived = createAction(
  '[Allocation WebSocket] Allocation Notification Received',
  props<{ notification: any }>()
);

export const markNotificationAsRead = createAction(
  '[Allocation] Mark Notification As Read',
  props<{ notificationId: string }>()
);

export const markNotificationAsReadSuccess = createAction(
  '[Allocation] Mark Notification As Read Success',
  props<{ notificationId: string }>()
);

export const acknowledgeNotification = createAction(
  '[Allocation] Acknowledge Notification',
  props<{ notificationId: string; gameId: number; teamId: number }>()
);

export const acknowledgeNotificationSuccess = createAction(
  '[Allocation] Acknowledge Notification Success',
  props<{ notificationId: string }>()
);

export const acknowledgeNotificationFailure = createAction(
  '[Allocation] Acknowledge Notification Failure',
  props<{ notificationId: string; error: string }>()
);

export const dismissNotification = createAction(
  '[Allocation] Dismiss Notification',
  props<{ notificationId: string }>()
);

export const clearAllNotifications = createAction(
  '[Allocation] Clear All Notifications'
);

export const toggleNotificationsPanel = createAction(
  '[Allocation] Toggle Notifications Panel'
);

export const markAllNotificationsAsRead = createAction(
  '[Allocation] Mark All Notifications As Read'
);

export const loadNotificationHistory = createAction(
  '[Allocation] Load Notification History',
  props<{ gameId: number; teamId?: number }>()
);

export const loadNotificationHistorySuccess = createAction(
  '[Allocation] Load Notification History Success',
  props<{ notifications: any[] }>()
);

export const loadNotificationHistoryFailure = createAction(
  '[Allocation] Load Notification History Failure',
  props<{ error: string }>()
);
